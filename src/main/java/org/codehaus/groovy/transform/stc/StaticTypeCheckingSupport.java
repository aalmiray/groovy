...
public abstract class StaticTypeCheckingSupport {
    ...
    public static Object evaluateExpression(Expression expr, CompilerConfiguration config) {
        ...
        node.addMethod(markAsGenerated(node, new MethodNode("eval", Opcodes.ACC_PUBLIC + Opcodes.ACC_STATIC, OBJECT_TYPE, Parameter.EMPTY_ARRAY, ClassNode.EMPTY_ARRAY, code)));
