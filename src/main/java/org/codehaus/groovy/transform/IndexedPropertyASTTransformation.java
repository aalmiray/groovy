...
public class IndexedPropertyASTTransformation extends AbstractASTTransformation {
    ...
    private static void addGetter(FieldNode fNode, ClassNode componentType) {
        ...
        markAsGenerated(cNode, cNode.addMethod(makeName(fNode, "get"), getModifiers(fNode), componentType, params, null, body));
    }
    ...
    private static void addSetter(FieldNode fNode, ClassNode componentType) {
        ...
        markAsGenerated(cNode, cNode.addMethod(makeName(fNode, "set"), getModifiers(fNode), ClassHelper.VOID_TYPE, theParams, null, body));
    }
